        ...
        <div className="p-6 space-y-6">
          ...
          <div className="text-center">
            <div className="relative inline-block">
              <div
                className="w-24 h-24 rounded-full border-4 border-white shadow-xl flex items-center justify-center text-white font-bold text-2xl mx-auto"
            ...
            <p className="text-sm text-gray-500 mt-2">Profile Avatar</p>
          </div>
          ...
          <div>
            ...
            {isEditing ? (
              ...
              <div className="flex items-center gap-3">
                ...
                />
                <span className="text-gray-800 font-mono">{user?.color}</span>
              </div>
            )}
          </div>
